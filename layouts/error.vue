  ...
  <v-app>
    <v-card id="main" outlined light>
      <div>
        ...
        <v-card-subtitle>
          <a href="https://addtobasic.dev/">Go back to the top page.</a>
        </v-card-subtitle>
      </div>
      <div id="icon" class="animation">
        <img
          class="img1"
          src="../static/img/genshi_line_animated.svg"
          alt="genshi_svg"
        />
...
export default {
  ...
  methods: {
    reload() {
      ...
      $('.img1').attr(
        'src',
        'https://smash-bros-stage-select-app.web.app/_nuxt/img/genshi_line_animated.9ce9c6d.svg' +
          '?' +
          '' +
          now
      )
